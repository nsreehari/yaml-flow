...
async function writeReadme() {
  const readme = [
    ...
    '## Requirements',
    '',
    '- **Python 3.12** (required — the bundled `quickjs` wheel does not support 3.13+).',
    '  Verify with: `python --version` (must report `Python 3.12.x`).',
    '',
    '## Setup',
    '',
    '1. Create and activate a Python 3.12 virtual environment, e.g.:',
    '   ```',
