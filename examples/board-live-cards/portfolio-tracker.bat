...
echo   "provides": [{ "bindTo": "holdings", "src": "state.holdings" }], >> "%CARDS%\portfolio-form.json"
...
echo     ] >> "%CARDS%\portfolio-form.json"
echo   }, >> "%CARDS%\portfolio-form.json"
echo   "view": { >> "%CARDS%\portfolio-form.json"
echo     "elements": [ >> "%CARDS%\portfolio-form.json"
echo       { "kind": "table", "label": "Holdings", "data": { "bind": "state.holdings", "columns": ["symbol", "qty"] } } >> "%CARDS%\portfolio-form.json"
echo     ] >> "%CARDS%\portfolio-form.json"
echo   } >> "%CARDS%\portfolio-form.json"
echo } >> "%CARDS%\portfolio-form.json"
