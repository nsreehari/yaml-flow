...
// ============================================================================
// 4. Dynamic evolution: add a new data feed at runtime
// ============================================================================

console.log('\n=== Adding social_media_feed node ===');
live = addNode(live, 'social_media_feed', {
  provides: ['social-data'],
  description: 'Fetch social media mentions for sentiment',
});

// Wire it into sentiment_analysis
live = addNode(live, 'social_sentiment', {
  requires: ['social-data'],
  provides: ['social-sentiment'],
  description: 'Analyze social media sentiment',
});

// Now generate_signals can also use social sentiment
live = addNode(live, 'enhanced_signals', {
...
// ============================================================================
// 5. Token draining: expire stale data
// ============================================================================

console.log('\n=== Draining stale price-data ===');
live = drainTokens(live, ['price-data']);
...
live = injectTokens(live, ['price-data']);
console.log('Tokens after re-inject:', live.state.availableOutputs);

// ============================================================================
// 6. Disable a failing feed
// ============================================================================

console.log('\n=== Disabling social_media_feed ===');
live = disableNode(live, 'social_media_feed');
...
// Re-enable after fix
live = enableNode(live, 'social_media_feed');
